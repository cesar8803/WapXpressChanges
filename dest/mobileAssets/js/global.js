...
$('.close_promo, .close-banner').on('click', function() {
$(this).parents('.header-promo').fadeOut(300).slideUp(200);
});
//end
//login popup
...
/*agregue funcion pasada controla slide para tabletas*/
...
//$('.search-icon, .mobile-search-icon, .lp-search-cont-main #appendedInputButtons, .lp-search-cont-main .input-append button').on('click focus', function(e) {
$('.search-icon, .mobile-search-icon').live('click', function(e) {	
$('#search-container').modal('show');
$('#busca').val('');
var data = lpobj.ajaxGetContent('/tienda/m/common/frag/searchBox.jsp', "html");
...
$("input.cross_site_script_val_pop").focus();
});
$(".close-search, .close-search1").on("click", function() {
if (navigator.userAgent.match(/iPhone|iPad|iPod/i)) {
...
//pdp modal show
if((phoneWidth < 768)){
	$("div.lp-desc-sec").on("click", function(){
		$('#lp-pdp-box-contianer').modal('show');
		var pdpdata = $(this).children('div.lp-data-sec').html();
		$('#lp-pdp-box-data').html(pdpdata)
	});
	$(".close-search1").on("click", function() {
		$("#lp-pdp-box-contianer").modal('hide');
	});
}

$(".ipad-modal-scroll-locked").on("click", function(e) {
...
$(".filter-btn-icon").on('click', function() {
...
$(".filter-close, .filter-close1").on("click", function() {
...
$('.filter-tabs.selected').on('click', function() {
...
$(".compare-check input[type=checkbox]").on("click", function() {
if($(this).is(':checked')) {
...
//end
//view-promo-popup
$(".veiw-promo-popup-link").on('click', function() {
$.ajax({
type: "GET",
...
if (phoneWidth <= 650)
{
$('.sub-section h3').on('click', function() {
if (phoneWidth < 650) {
...
var haveText = $(this).text();

if(haveText.indexOf('Soporte                                                                                                                                                                                                 al cliente') > -1){
	$(this).addClass('active');
	$(this).parent('div').find('.phone-hide').slideDown(200);

}

console.log("tiene el texto: "+haveText+" / "+haveText.indexOf('Soporte al cliente'));
//$(this).addClass('active');
//remover comentario para la flecha hacia abajo jonh jon
}
}
});
}
...
//$('#megamenu_headerlink').css('min-height', '230px');
$('#megamenu_headerlink').css('background', '#FFF');
var documentWidth = $(document).width(); 
var documentHeight = $(document).height();
$("<div>").attr("id","dummyDiv").appendTo("body");
$("#dummyDiv").css({"width": documentWidth , "height": documentHeight, "position": "fixed", "top": "53px", "left": "0px", "background": "#FFF", "z-index": "1000"});
$(window).resize(function() {
  var documentWidth = $(document).width(); 
  var documentHeight = $(document).height();
  $("#dummyDiv").css({"width": documentWidth , "height": documentHeight, "position": "fixed", "top": "53px", "left": "0px", "background": "#FFF", "z-index": "1000"});
...
lpobj.showMegamenuMobile();
//quitar cuando el menú deje de ser fixed cambiar por "this"
$(".header-navigation-left").addClass('active');
$('body').addClass('menu-active');
//$('#megamenu_headerlink').css('min-height', '230px');
$('#megamenu_headerlink').css('background', '#FFF');
var documentWidth = $(document).width(); 
...
$(".mega-left").height(winHeight-53);
$(".menu-right-cont").height(winHeight-53);
$('.right-menu h3').on("click", function() {
...
$('.prod-desc h4').on('click', function() {
...
$(".selected-range").on('click', function(e) {
       e.preventDefault();
       $( ".price-dropdown" ).each(function( index, value ) {
                if($(this).css('display') == 'block')
                       { $(this).slideUp();}
              });
       $(this).next('.price-dropdown').slideToggle();
       //$(this).find(".price-dropdown").slideToggle();
...
/*$(this).parents('.filter-section').find('.filter-lables').fadeToggle(350);*/
	if($(this).next("div").is(":visible")){
		...
		$(this).toggleClass('active');
		/*$("#jai").toggleClass('collapse');*/
	} else {
		/*$(".filter-section").find('.filter-lables').slideUp("slow");*/
...
//popup
$(".cart-popup-link").on('click', function() {
...
if (deviceType == "web") {
$('.shopping-bag').on('mouseenter', function() {
setTimeout(function() {
lpobj.minicartopen();
}, 100)
});
$('.shopping-bag').on('mouseleave', function() {
lpobj.minicartclose();
});

} else {
$('.cart-link.touchEvent').on(eventMouseEnterType[deviceType], function() {
var obj = this;
if (phoneWidth < 768) {
...
$('.promo-load-btn').on('click', function() {
...
$('.support-tab-mobile .btn-navbar,.support-tab-mobile .leftnavbar a').on('click', function() {
...
$('.support-tab-links-mobile .tablink').on('click', function() {
...
$('.capatcha-txt, .captcha-input').on('blur',function(){
if($(this).val() == ''){
...
$(".date_data").on('keydown focus',function(){
...
var actualHeight = winheight - headerHeight;
var actualHeightN = winheight - headerHeight;
$('.menu-right-cont').css('height', actualHeightN);
$(".header_shopcat_container").css({'overflow-y': 'scroll','height': actualHeight,'width': '100%'});
...
//$(".mobmenuContent").css("width","100%"})
$(".mobmenuContent").css("position","fixed");
$(".mobmenuContent").css("top","-100%");
$(".mobmenuContent").css("left","0%");
$(".mobmenuContent").css("width","100%");
$(".mobmenuContent").css("height","100%");
$(".mobmenuContent").css("z-index","9999");

var heightHDR = $(".header-navigation-main").height();
var heightHDR = heightHDR+"px"
$(".mobmenuContent").animate({"top": heightHDR},300,function(){});
//console.log(winHt);
...
$(".mobmenuContent").css("position","absolute");
$(".mobmenuContent").css("left","0%");
$(".mobmenuContent").css("width","100%");
$(".mobmenuContent").css("height","100%");
$(".mobmenuContent").css("z-index","999");


$(".mobmenuContent").animate({"top": "-100%"},300,function(){});
...
$(".promo-principal img, .homelslider img").lazyload();
pp.carouFredSel({
circular: true,
infinite: true,
scroll: {
...
pp.parent().add(pp).css('height', pp.children().first().height() + 'px');
}).trigger('resize');
...
/*agrgue funcion pasada controla slide para tabletas*/
tableslideInit: function() {
$(".promo-principal img, .tabletslider img").lazyload();
...
$('.tabnavigationcontainer .tabs a.pdpTab').on('click', function() {
var phoneWidth = $(window).width();
if (!($(this).parent('li').hasClass('active')))
{
var tabLinkVal = $(this).find('.tabID').val();
...
$('.updateprofilelink').on('click', function() {
lpobj.showLoginPopup($(this).attr( "title" ));
});

$('.nospc_nosp').bind('keypress', function (event) {
//alert(event.charCode);
var exceptMatern = $(this).attr("id");

if(exceptMatern == "nom_text" || exceptMatern == "nom_text1" || exceptMatern == "nom_text2" || exceptMatern == "nom_text3" || exceptMatern == null){
...
$('.txt-add-normalmessage').on('click', function() {
$(this).next(".ui-layer-normalmessage").slideToggle( "slow" );
//lpobj.showLoginPopup($(this).attr( "title" ));
});
$('.txt-add-ebookmessage').on('click', function() {
...
if(heightcontent){
/*$('.precio-modulo').removeClass('moreheight');*/
//$('.precios_producto').css("height","30px");
$('.precios_producto').removeClass("moreheight");

//$('.precio-modulo').css("height","30px");
if($('.prod-info').exists()){
if(!$('.ebookpdpdp').exists()){
/*if (phoneWidth >= 768) 
{lpobj.setdynamicheight('moreheight',1,'moreheight');}
...
$(function(){
	...
	$('.small-veiw').on('click',function(){
		...
		/* fixing the plp-category-result label on header - Suresh */
		$( ".row-fluid .top-fix" ).css("top", $( ".header-navigation" ).height());
		$( window ).resize(function() {
			  $( ".row-fluid .top-fix" ).css("top", $( ".header-navigation" ).height());
		});
	});
	...
	$(document).ready(function() {
		...
		//Menu lateral evitar el PLP en segundo nivel
		$('.right-menu h3 a').click(function(event){
		    event.preventDefault();
		 });    
		
		
		//Una validacion temporal para detectar si es un ipad, debido a que no esta implementado para este dispositivo
		var isiPad = navigator.userAgent.match(/iPad/i) != null;
		
		if(true){
				var htmlFirstLevel = '<li><a href="/tienda/m" title="Marcas" rel="catmarcas" class="Marcas" class="active">  Marcas</a></li>';		
		...
		$(".menu-brand").hide();
		$('.mega-leftul li a').on('click', function(e) {
			e.preventDefault();
			if($(this).text() === "  Marcas"){
				$(".menu-brand").show();
				$(".menu-category").hide();
				$(this).text("Regresar");
				$(this).addClass("menuBack");
			}
			else if($(this).text() === "Regresar"){
				$(".menu-brand").hide();
				$(".menu-category").show();
		...
		if ($(".category-container")[0]){
		    // Do something if .category-container class exists
		      //debugger;
/* Commented JSON request
		    var jqxhr = $.getJSON( window.location.href+"?format=json", function(data) {
		      console.log( "success" );
		      dataResponse = data;
		  }).done(function() {
		  ...
		  //Commented JSON request
		 // $(".cat-products").click(categoryPressed);

		function categoryPressed(event) {
		        if(dataResponse!=null){
		              event.preventDefault();
		              var nameLabel = $(this).find("h3")[0].outerText;
		              
		              var arrayRefinements =  dataResponse.contents[0].secondaryContent[1].refinements;

		            if(arrayRefinements!=null){

		                      var arrayLength = arrayRefinements.length; 
		                    for (var i = 0; i < arrayLength; i++) {
		                       // alert(arrayRefinements[i].label);

		                       if( nameLabel ==arrayRefinements[i].label){
		                          window.location.href =  "/tienda/m"  + arrayRefinements[i].navigationState.replace("?format=json", "");
		                          break;
		                       }
		                        //Do something
		                    }
	...
	if(isiPad!= -1 || isiPod > -1)
	{
		
		
		$("#btn-view-grid").click(function(){
			$("ul.pdt-list li").toggleClass("span3 super-view");
			if($("#btn-view-grid").attr("src") == "/mobileAssets/images/icons/large-view-grid.png"){
			$("#btn-view-grid").attr("src","/mobileAssets/images/icons/small-view-grid.png");
			$(".ebookdesc").show();
			localStorage.setItem("visited", "small-view");
			
			}else{
			       $("#btn-view-grid").attr("src","/mobileAssets/images/icons/large-view-grid.png");
			       $(".ebookdesc").hide();
			       localStorage.setItem("visited", "large-view");
			}
	...
	$(document).ready(function() {
            ...
            $("ul.card-nav li.active a span.top-menu-expanded").html("");
            $("ul.card-nav li a span").html("");
                       $(".lp-filtros-sec  .filter-section  .filter-lables  .row-fluid  .span6 > input[type=checkbox]").click(function(){
                                                    
                                                    var chk = $(this);
                                                	var act = chk.is(":checked");
                                  console.log(chk);
                            console.log(act);
                       ...
                       $(".lp-filtros-sec  .filter-section  .filter-lables  .row-fluid  .span6").click(function(){
	
                        	var chk = $(this).find("input[type=checkbox]");
                        	//var lbl = $(this).find("label span ");

                        	var act = chk.is(":checked");
                             
                           // var fnc = chk.attr("onchange","");
	...
	var inputCheck = $("input#nip_express");
 if(inputCheck != null){
$("input#nip_express").prop("type", "number");
 }else{


 }

    var telcelVar = $(".row-fluid > .breadcrumb > ul > li:last-child").html();
    if(telcelVar!=null){
        //telcelVar.indexOf('Telcel');

        if(telcelVar.indexOf('TELCEL') != -1 || telcelVar.indexOf('Telcel') != -1 || telcelVar.indexOf('telcel') != -1){
            
            $( "ul.pdt-list > li .prod-info .precios_producto p[itemprop='highPrice']" ).each(function() {
                  var textPriceHight = $(this).html();
                         console.log(textPriceHight);


                    if(textPriceHight != "" ){

         	       $(".newprice").css("display","none");
                    $("p[itemprop='highPrice']").removeClass("precio-tachado-modulo");
                    $("p[itemprop='highPrice']").addClass("precio-promocion-modulo precio-especial-telcel");
                 }
                    
             });
           $( "ul.pdt-list > li .prod-info .precios_producto p.precio-modulo.newprice" ).each(function() {
                
                    var precioModulo =    $(this).html();

                 if(precioModulo != "" || precioModulo != null || precioModulo != undefined){
...
/*$("#megaMenu_images > li > a.Zapatos").click(function(){
       window.location.href = 'http://www.liverpool.com.mx/zapatos/';

});*/

$("ul.pdt-list-detail > li.span3").click(function(){
 
var linkDetect = $(this).find("div.lrpl-thumbnail > a");	
if(linkDetect != null){
console.log(linkDetect);

var obtainLink = $(linkDetect).attr("href");
var urlHostname = window.location.hostname;
console.log("http://"+urlHostname);
var url      = "http://"+urlHostname; 
if(obtainLink != null){
	 console.log(url+obtainLink);

     window.location.href = url+obtainLink;
//$(linkDetect).click();

}else{
	console.log("no encontramos link");
...
$("#airtime-payment-step > section > div.airtime-content-body > div.row-fluid.mt20 > div.airtime-payment-details > div.row-fluid.accept_check.mt15 > div.span12.checkbox > label > a ").attr('href','http://www.liverpool.com.mx/ayuda/terminos-y-condiciones.html');
///$('body > div.wrapper > ul.card-nav > li > ul.card-nav-sub-links > li:nth-child(2) > a').css("display","none");
$('body > div.wrapper > ul.card-nav > li > ul.card-nav-sub-links > li:nth-child(2) > a:contains("Contrato liverpool FASHION CARD")').css("display","none");

var creditoLiverFooter  = $("body > div.wrapper > footer > div.footer-bottom > div.row-fluid.footerbtcontent > div > div:nth-child(1)");
if(creditoLiverFooter != null){
	var footCrdLog = $("body > div.wrapper > footer > div.footer-bottom > div.row-fluid.footerbtcontent > div > div:nth-child(1) > div > h3").hasClass("loginnowuser");
		console.log("footer login "+footCrdLog);

		$("body > div.wrapper > footer > div.footer-bottom > div.row-fluid.footerbtcontent > div > div:nth-child(1)").click(function(){ 
		   if(footCrdLog==true){	
		   	            location.href="/tienda/m/users/credit/myCards.jsp";
		   }else{
		   				location.href="/tienda/m/users/credit/creditLandingPage.jsp";

		   }
		});
}

var tiempoFooter = $("body > div.wrapper > footer > div.footer-bottom > div.row-fluid.footerbtcontent > div > div:nth-child(3)");
if(tiempoFooter != null){
	$("body > div.wrapper > footer > div.footer-bottom > div.row-fluid.footerbtcontent > div > div:nth-child(3)").click(function(){ location.href="/tienda/m/checkout/airtimeTicket.jsp";});
}
var mesaRegalosFoot =$("body > div.wrapper > footer > div.footer-bottom > div.row-fluid.footerbtcontent > div > div:nth-child(2)");
if(mesaRegalosFoot != null){
$("body > div.wrapper > footer > div.footer-bottom > div.row-fluid.footerbtcontent > div > div:nth-child(2)").click(function(){ location.href="/tienda/m/giftregistry/giftRegistry.jsp?eventNo=1";});
}
//$('#jai > div > div > ul:nth-child(5) > li > a > span:contains("Alfabéticamente (Z a A)")').css("display","none");

var linkRegBtn = $('body > div.wrapper > section.credits-landing-container > div:nth-child(1) > div:nth-child(2) > div:nth-child(3) > a');
if(linkRegBtn != null){
$('body > div.wrapper > section.credits-landing-container > div:nth-child(1) > div:nth-child(2) > div:nth-child(3) > a').click(function(event){
event.preventDefault();
location.href = '/tienda/m/users/register.jsp';
});
}
...
/*Desactiva las categorías de primer nivel*/
$(document).ready(function(){
	$(".mega-menu_headertext").click(function(e){
		e.preventDefault();
	})
});
//a falta de key mostrar más productos
$(function(){
	
	$('.load-more').text('Mostrar más productos');
	
});
$(".plpsearchicon").click(function(){
	$(".close-search, .close-search1").on("click", function() {
		if (navigator.userAgent.match(/iPhone|iPad|iPod/i)) {
			lpobj.animateBodyHeightAfterSearchClose();
		}
...
//*Remove brand
$(document).ready(function(){
	$("#megaMenu_images > li:nth-child(44)").remove();
...
$(document).ready(function(){
    ...
    $(".bootom-footer").append("<p class='temporary-label-footer'>Las promociones de liverpool.com.mx pueden diferir de las promociones publicadas en tienda.</p>");
    $(".temporary-label-footer").insertAfter(".tmc_wap_footer");
    $("input.btn-pink.pull-right.credit-card-submit-btn").attr("value","Agregar tarjeta");
    $("#go-ini").click(function(){$("body,html,.wrapper,.mobmenu").animate({ scrollTop: 0 }, "fast");});
    $(".mega-leftul").before("<div style=\"display:block;background:#ccc;font-family:Roboto Regular; text-align:center;padding:5px;\"><span>Busca por departamento</span></div>");
   
    //$('div.lp-filtr-dept-sec > div.filter-section.lp-filtr-sub > h3').trigger("click");


    $(".header-navigation").css("z-index","9999");


});
clickOnOrdenar();
function clickOnOrdenar(){
//$('div.lp-filtr-dept-sec > div.filter-section.lp-filtr-sub > h3').on('click', function() {

$("#minPrice").val('');
$("#maxPrice").val('');
/*$(this).parents('.filter-section').find('.filter-lables').fadeToggle(350);*/
	if($("div.lp-filtr-dept-sec > div.filter-section.lp-filtr-sub > h3").next("div").is(":visible")){
		$("div.lp-filtr-dept-sec > div.filter-section.lp-filtr-sub > h3").next("div").slideUp("slow");
		$("div.lp-filtr-dept-sec > div.filter-section.lp-filtr-sub > h3").toggleClass('active');
		/*$("#jai").toggleClass('collapse');*/
	} else {
		/*$(".filter-section").find('.filter-lables').slideUp("slow");*/
		$("div.lp-filtr-dept-sec > div.filter-section.lp-filtr-sub > h3").next("div").slideDown("slow");
		$("div.lp-filtr-dept-sec > div.filter-section.lp-filtr-sub > h3").toggleClass('active');
		/*$("#jai").toggleClass('collapse');*/
	}
//});
...
function goIni(){
	$("body,html,.wrapper,.mobmenu").animate({ scrollTop: 0 }, "fast");
}