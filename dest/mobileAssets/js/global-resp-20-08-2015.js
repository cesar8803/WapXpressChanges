...
$(function(){
	...
	$(document).ready(function() {
		...
		//Oculta los filtros excepto CategorÃ­a y Marcas
		$(".lp-filtros-sec .filter-section").each(function(){
			var texto = $(this).children("h3").text();
			if((texto != "Categor\u00EDa" && texto != "Categoria" && texto != "Marca")){
			$(this).hide()
			}
		...
		//AquÃ­ termina el ocultado de filtros excepto categorÃ­a y marcas
				...
				$.get( "/mobileAssets/ajax/marcascontent.html", function( data ) {
				  	...
				  	//alert(data);
				  				...
				  				$('span.visible-phone.marcas').click(function() {
									//Buscamos el elemento padre del item de la lista y obtenemos el link del elemento ancla para hacer una redireccion.
...
$("#megaMenu_images > li > a.Videojuegos").click(function(){
window.location.href = 'http://www.liverpool.com.mx/videojuegos/';
});
...
/*Comienza script para el menu*/
	$catPadre = $("#megaMenu_images li a")
	$catSecundaria = $(".megamenucategories .right-menu h3 a")
	$catUltimoNivel = $(".right-menu ul li a:last-child")
	$catPadre.on("touchstart",function(){
		$(this).addClass("activo");
	});
	$catPadre.on("touchend",function(){
		$(this).removeClass("activo");
		console.log("terminó el Touch"+$(this))
	});

	$catSecundaria.on("touchstart",function(){
		$(this).addClass("activo");
	});
	$catSecundaria.on("touchend",function(){
		$(this).removeClass("activo");
		console.log("terminó el Touch"+$(this))
	});

	$catUltimoNivel.on("touchstart",function(){
		$(this).addClass("activo");
	});
	$catUltimoNivel.on("touchend",function(){
		$(this).removeClass("activo");
		console.log("terminó el Touch"+$(this))
	});
/*Termina Script para el menu*/
	$('body > div.footer-bottom > div.row-fluid.footerbtcontent > div > div:nth-child(5) > div > a > h3').click(function(){
	$('body > div.footer-bottom > div.row-fluid.footerbtcontent > div > div:nth-child(5) > div > a > h3').removeClass('active'); 
    });
