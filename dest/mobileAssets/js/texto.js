...
var eventMouseEnterType = {
    'nonWeb': 'touchstart'
};
var eventMouseLeaveType = {
    'nonWeb': 'mouseleave'
};
...
(function($) {
    $(function() {
            ...
            if ($('.prod-info').exists()) {
                ...
                if (!$('.ebookpdpdp').exists()) {
                    ...
                    if (phoneWidth >= 768) {
                        ...
                        lpobj.setdynamicheight('prod-info', 1, 'moreheight');
                    }
                }
            }
        ...
        $('.search-icon').live('click touch', function(e) {
        ...
        $(".filter-close, .filter-close1").on("click", function() {
            $(".filter-container").animate({
                right: -$(".filter-container").outerWidth()
            });
            lpobj.hideOverlayFilter();
    ...
    lpobj = {
        ...
        initTabNavigation: function() {
            $('.tabnavigationcontainer .tabs a.tablink').on('click', function() {
        ...
        showScroll: function(scroll, requiredArrow, reinitialise) {
            var api = $(scroll).jScrollPane({
                showArrows: requiredArrow,
                autoReinitialise: reinitialise
            }).data().jsp;
            api.reinitialise();
        },
        ...
        animateBodyHeightAfterSearchClose: function() {
            setTimeout(function() {
                ...
                if (navigator.userAgent.match(/iPhone/i)) {
                    ...
                    $("html, body").animate({
                        scrollTop: $("body").data("scrolltop") + "px"
                    }, 30, function() {
                        $('#search-container').modal("hide");
                        $(".modal-scrollable").removeClass("ipad-modal-scroll-locked");
                        $("#field-search").val("");
                    ...
                    if (!$this.data('barrating')) {
                        ...
                        $this.find('option').each(function() {
                            ...
                            if (val) {
                                ...
                                $span = $('<span />', {
                                    text: (userOptions.showValues) ? text : ''
                                });
