...
// Position nodes
this.timelineWidth = this.el.innerWidth()-30;
...
left = ((this.timelineWidth/(this.events.length-1))*i - this.eventNodeWidth / 2) + 2;
...
left = this.timelineWidth - this.eventNodeWidth/2 - (this.draggableWidth/2) + 2;
if(phoneWidth < 770){
left = left+3;
}
}
...
left = this.timelineWidth - this.events[i].title.outerWidth() + 2;
if(phoneWidth < 770){
left = left+3;
}
} else {
...
var draggablePos = this.draggable.position().left;
var index = Math.round(((draggablePos+1) - (this.draggableWidth/2 - this.eventNodeWidth/2)) / (this.timelineWidth/(this.events.length-1)));
