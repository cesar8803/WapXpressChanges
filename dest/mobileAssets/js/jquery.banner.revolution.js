   jQuery(document).ready(function() {
        ...
        jQuery('.contenedorAvent').revolution2({

        });
        jQuery('.contenedorSmall').revolution3({
    ...
    jQuery.fn.extend({
        ...
        revolution: function(options) {
            ...
            defaults = {
                ...
                fullScreen: "off",
                minFullScreenHeight: 460, // The Minimum FullScreen Height
         ...
         // // MEDIUM BANNER 950X400
        revolution2: function(options) {
            defaults = {
                delay: 3500,
                startheight: 400,
                startwidth: 950,
        ...
        // SMALL BANNER 950X240
        revolution3: function(options) {
            defaults = {
                delay: 3500,
                startheight: 240,
                startwidth: 950,
